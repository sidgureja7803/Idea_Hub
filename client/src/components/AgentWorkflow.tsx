...
const AgentWorkflow: React.FC = () => {
  ...
  // Data for the 5 specialized agents as per README
  const agents: AgentProps[] = [
    {
      name: "Idea Normalizer",
      description: "Structures and clarifies your startup idea with Llama 3 8B.",
    ...
    {
      name: "Market Analyst",
      description: "Conducts comprehensive market research with Llama 3.3 70B.",
      icon: <Search size={24} />,
      color: "bg-blue-500",
      index: 1
    },
    {
      ...
      description: "Maps the competitive landscape using Llama 3.3 70B.",
      icon: <Users size={24} />,
      color: "bg-red-500",
      index: 2
    },
    {
      ...
      description: "Assesses technical and financial viability with Llama 3 8B.",
    ...
    },
    {
      ...
      description: "Generates go-to-market strategies with Llama 3.3 70B.",
        ...
        <div className="relative bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="p-4 border border-blue-200 dark:border-blue-800 rounded-lg bg-blue-50 dark:bg-blue-900/20">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">5 specialized agents analyze different aspects sequentially</p>
            </div>
